...
const ranxplorerMiddleware = (prefix) =>
  createProxyMiddleware({
        ...
        if (
          ...
          links.each(function () {
            ...
            if (href !== undefined) {
              $(this).attr(
                "href",
                href.replace("https://ranxplorer.com", domain)
              );
            }
          });
          let forms = $("form");
          forms.each(function () {
            ...
            if (action !== undefined) {
              $(this).attr(
                "action",
                action.replace("https://ranxplorer.com", domain)
              );
            }
          });
          let anchors = $("a");
          ...
          scripts.each(function () {
            ...
            if (src == undefined) {
              ...
              let newContent = content.replaceAll(
                "window.location.href = 'ranxplorer.com/keywords'",
                "window.location.href = 'https://ranxplorer.com/keywords'"
              );
              newContent = newContent.replace(
                /https:\/\/ranxplorer.com/g,
                domain
              );
              $(this).html(newContent);
            } else {
              if (src == "https://analytics.kifstat.fr/js/script.js") {
                $(this).remove();
              } else {
                $(this).attr(
                  "src",
                  src.replace("https://ranxplorer.com", domain)
                );
              }
            }
          });
          ...
          if (req.path == "/login") {
            let html = fs.readFileSync(
              __dirname + "/../views/ranxplorer-auth.ejs"
            );
