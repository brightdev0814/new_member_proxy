const {
  ...
  const seodityMiddleware = (prefix) =>
    createProxyMiddleware({
          ...
          if (
            ...
            links.each(function () {
              ...
              if (href !== undefined) {
                $(this).attr(
                  "href",
                  href.replace("https://app.seodity.com", domain)
                );
              }
            });
            let forms = $("form");
            forms.each(function () {
              ...
              if (action !== undefined) {
                $(this).attr(
                  "action",
                  action.replace("https://app.seodity.com", domain)
                );
              }
            });
            let anchors = $("a");
            ...
            scripts.each(function () {
              ...
              if (src != undefined) {
                if (src.includes("https://app.seodity.com/assets/index-")) {
                  $(this).remove();
                } else {
                  $(this).attr(
                    "src",
                    src.replace("https://app.seodity.com", domain)
                  );
                }
              }
            });
            ...
            $("head").append(
              `<script>var user = ${JSON.stringify(req.user)};</script>`
            );
            $("head").append(
              "<script type='module' crossorigin src='/js/seodity.js' type='text/javascript'></script>"
            );
