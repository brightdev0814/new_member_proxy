...
const indexmenowAuthLogin = async (email, password) => {
  return new Promise(async (resolve, reject) => {
    const windowsLikePathRegExp = /[a-z]:\\/i;
    let inProduction = false;
...
const publicwwwAuthLogin = async (email, password) => {
  return new Promise(async (resolve, reject) => {
    const windowsLikePathRegExp = /[a-z]:\\/i;
    let inProduction = false;
...
const searchatlasAuthLogin = async (username, password) => {
  return new Promise(async (resolve, reject) => {
    try {
...
const wincherAuthLogin = async (username, password) => {
  return new Promise(async (resolve, reject) => {
    try {
      const body = `grant_type=password&client_id=wincher-web&scope=api offline_access&username=${username}&password=${password}`;
      const response = await http.instance.post(
